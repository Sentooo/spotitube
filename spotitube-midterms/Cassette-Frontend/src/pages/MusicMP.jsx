    ...
    <LayoutMP activePage={"Home"}>
      <div className="dashboard-container">
        ...
        <div className="artist-title-viewmore">
          <h5 className="artist-title" onClick={handleOpen}>
            Popular Artists
          </h5>
          <Link to="/artist" className="view-morebtn">
            Show all
          </Link>
        </div>
        ...
        <div className="albums-title-viewmore">
          <h5 className="albums-title">Recent Albums</h5>
          <Link to="/albums" className="view-morebtn">
            Show all
          </Link>
        </div>
