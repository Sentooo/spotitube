...
import AlbumImg from "../assets/img/SpotitubeLogo.png";
...
import MusicPlayer from "../Components/Music-Player"; // Import FooterPlayer component
...
function Album() {
  ...
  const playAlbum = () => {
    setShowMusicPlayer(true); // Show FooterPlayer when play button is clicked
  };
  ...
  const handleSaveClick = (e) => {
    ...
    cassette_api.post("album/update/", newAlbumData).then((response) => {
  ...
  const [showMusicPlayer, setShowMusicPlayer] = useState(false); // State for FooterPlayer visibility
                    ...
                    <td>
                      <div className="p-track-info">
                        <img
                          ...
                          alt={`Track ${track.number}`}
                          className="p-track-image"
                        />
                    ...
                    {edit && (
                      <td className="albumMusicDelete">
                        ...
                        >
                          <FontAwesomeIcon
                            icon={faTrashCan}
                            className="albumMusicDelete"
                            onClick={(e) => deleteMusicModal(track.id)}
                          />
                        </Tooltip>
                      </td>
                    )}
        ...
        <div className="top-container position-relative ">
          {canEdit && (
            <>
              ...
              >
                <FontAwesomeIcon
                  icon={edit ? faCheck : faEdit}
                  className="albumEditIcon"
                  onClick={edit ? (e) => handleSaveClick(e) : handleEditClick}
                />
              </Tooltip>
              <Tooltip data-toggle="tooltip" data-html="true" title="Delete">
                <FontAwesomeIcon
                  icon={faTrashCan}
                  className="albumDeleteIcon"
