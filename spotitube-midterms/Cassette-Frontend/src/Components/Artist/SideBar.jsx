...
import artistProfile from "../../assets/img/1.png";
...
function SideBar({ active }) {
  return (
    <div className="col-2 bg-light m-0 p-0">
      <div
        className={`row d-flex flex-column m-0 p-0 h-100 text-light ${styles["sidenav-container"]}`}
      >
        ...
        <div className="col-3 h-50 w-100">
          <div className="row h-100 d-flex flex-column justify-content-start pt-3 align-items-start ">
            <div
              className={`col ${styles["sidenav-links"]} ${
                active === "Upload" ? styles["active"] : ""
              }`}
            >
              <div>Upload</div>
            </div>
            ...
            <div
              className={`col ${styles["sidenav-links"]} ${
                active === "Playlists" ? styles["active"] : ""
              }`}
            >
              <div>Playlists</div>
            </div>
